        ...
        <div className="container mx-auto px-4 relative z-10">
           <div className="flex flex-col md:flex-row justify-between items-end mb-16">
              <div className="max-w-xl">
                 ...
                 <h2 className="text-4xl font-bold text-gray-900 leading-tight">Vier krachtige oplossingen voor uw woning.</h2>
              </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group bg-white rounded-3xl p-2 shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-500 flex flex-col">
                 <div className="relative h-56 rounded-2xl overflow-hidden mb-6 bg-gray-100">
                    <img src="https://voordeligste-warmtepomp.nl/wp-content/uploads/2025/03/image-2.png" alt="Batavia" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
